...
class Datos2 {
    constructor() {
        this.productos = [];
        this.agregarProductos(1,"Excellent","Adulto","1","3416","Gato","Excellent","Forastero");
        this.agregarProductos(154,"Excellent","Adulto","3","9359","Gato","Excellent","Forastero");
        this.agregarProductos(2,"Excellent","Adulto","7.5","20168","Gato","Excellent","Forastero");
        this.agregarProductos(3,"Excellent","Kitten","1","3792","Gato","Excellent","Forastero");
        this.agregarProductos(4,"Excellent","Kitten","7.5","22333","Gato","Excellent","Forastero");
        this.agregarProductos(5,"Excellent","Sterilized","1","3980","Gato","Excellent","Forastero");
        this.agregarProductos(6,"Excellent","Sterilized","7.5","23238","Gato","Excellent","Forastero");
        this.agregarProductos(7,"Excellent","Urinary","1","3980","Gato","Excellent","Forastero");
        this.agregarProductos(8,"Excellent","Urinary","7.5","23238","Gato","Excellent","Forastero");
        this.agregarProductos(9,"Excellent","Puppy Small","3","6513","Perro","Excellent","Forastero");
        this.agregarProductos(10,"Excellent","Puppy Small","15","25533","Perro","Excellent","Forastero");
        this.agregarProductos(11,"Excellent","Puppy Grande","3","6308","Perro","Excellent","Forastero");
        this.agregarProductos(12,"Excellent","Puppy Grande","15","24733","Perro","Excellent","Forastero");
        this.agregarProductos(13,"Excellent","Mini Adulto","3","5958","Perro","Excellent","Forastero");
        this.agregarProductos(14,"Excellent","Mini Adulto","15","23368","Perro","Excellent","Forastero");
        this.agregarProductos(15,"Excellent","Adulto Grande","3","5720","Perro","Excellent","Forastero");
        this.agregarProductos(16,"Excellent","Adulto Grande","15","22430","Perro","Excellent","Forastero");
        this.agregarProductos(183,"Excellent","Adulto Grande","20","26640","Perro","Excellent","Forastero");
        ...
        this.agregarProductos(18,"Biopet","Mini Adulto","15","8100","Perro","Biopet","Popy");
        this.agregarProductos(19,"Biopet","Adulto","20","9370","Perro","Biopet","Popy");
        ...
        this.agregarProductos(41,"Cat Chow","Adulto ","8","14586","Gato","Cat Chow","Forastero");
        this.agregarProductos(42,"Cat Chow","Adulto ","15","25091","Gato","Cat Chow","Forastero");
        this.agregarProductos(43,"Cat Chow","Kitten ","8","15696","Gato","Cat Chow","Forastero");
        this.agregarProductos(44,"Cat Chow","Kitten ","15","27024","Gato","Cat Chow","Forastero");
        this.agregarProductos(45,"Pro Plan","Adulto Small","7.5","21479","Perro", "Pro Plan","Forastero");
        this.agregarProductos(149,"Pro Plan","Adulto Small","3","10270","Perro", "Pro Plan","Forastero");
        this.agregarProductos(46,"Gati","Adulto ","15","14145","Gato","Gati","Forastero");
        ...
        this.agregarProductos(184,"Optimun","Adulto ","10","15980","Gato","Optimun","Chubutin");
        ...
        this.agregarProductos(64,"Dog Chow","Adulto Light","8","10362","Perro","Dog Chow","Forastero");
        this.agregarProductos(65,"Dog Chow","Adulto Light","21","24853","Perro","Dog Chow","Forastero");
