...
class Datos2 {
    constructor() {
        this.productos = [];
        this.agregarProductos(1,"Excellent","Adulto","1","6391","Gato","Excellent","Forastero");
        this.agregarProductos(154,"Excellent","Adulto","3","17512","Gato","Excellent","Forastero");
        this.agregarProductos(2,"Excellent","Adulto","7.5","37753","Gato","Excellent","Forastero");
        this.agregarProductos(148,"Excellent","Adulto","15","72803","Gato","Excellent","Forastero");
        this.agregarProductos(3,"Excellent","Kitten","1","7095","Gato","Excellent","Forastero");
        this.agregarProductos(4,"Excellent","Kitten","7.5","41786","Gato","Excellent","Forastero");
        this.agregarProductos(5,"Excellent","Sterilized","1","7447","Gato","Excellent","Forastero");
        this.agregarProductos(6,"Excellent","Sterilized","7.5","43481","Gato","Excellent","Forastero");
        this.agregarProductos(7,"Excellent","Urinary","1","7447","Gato","Excellent","Forastero");
        this.agregarProductos(8,"Excellent","Urinary","7.5","43481","Gato","Excellent","Forastero");
        this.agregarProductos(9,"Excellent","Puppy Small","3","12186","Perro","Excellent","Forastero");
        this.agregarProductos(10,"Excellent","Puppy Small","15","47776","Perro","Excellent","Forastero");
        this.agregarProductos(11,"Excellent","Puppy Grande","3","11803","Perro","Excellent","Forastero");
        this.agregarProductos(12,"Excellent","Puppy Grande","15","46278","Perro","Excellent","Forastero");
        this.agregarProductos(13,"Excellent","Mini Adulto","3","11147","Perro","Excellent","Forastero");
        this.agregarProductos(14,"Excellent","Mini Adulto","15","43723","Perro","Excellent","Forastero");
        this.agregarProductos(15,"Excellent","Adulto Grande","3","10702","Perro","Excellent","Forastero");
        this.agregarProductos(16,"Excellent","Adulto Grande","15","41968","Perro","Excellent","Forastero");
        ...
        this.agregarProductos(25,"Old Prince","Cachorro Small","7.5","19872","Perro","Old Prince","Don Tomas");
        ...
        this.agregarProductos(41,"Cat Chow","Adulto ","8","27292","Gato","Cat Chow","Forastero");
        this.agregarProductos(42,"Cat Chow","Adulto ","15","46947","Gato","Cat Chow","Forastero");
        this.agregarProductos(43,"Cat Chow","Kitten ","8","29834","Gato","Cat Chow","Forastero");
        this.agregarProductos(44,"Cat Chow","Kitten ","15","51366","Gato","Cat Chow","Forastero");
        ...
        this.agregarProductos(63,"Dog Chow","Mini Adulto","21","48169","Perro","Dog Chow","Forastero");
        this.agregarProductos(64,"Dog Chow","Adulto Light","8","19388","Perro","Dog Chow","Forastero");
        this.agregarProductos(65,"Dog Chow","Adulto Light","21","46501","Perro","Dog Chow","Forastero");
