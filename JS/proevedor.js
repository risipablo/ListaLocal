...
class Datos2 {
    constructor() {
        this.productos = [];
        this.agregarProductos(1,"Excellent","Adulto","1","5072","Gato","Excellent","Forastero");
        this.agregarProductos(154,"Excellent","Adulto","3","13898","Gato","Excellent","Forastero");
        this.agregarProductos(2,"Excellent","Adulto","7.5","29948","Gato","Excellent","Forastero");
        this.agregarProductos(148,"Excellent","Adulto","15","57780","Gato","Excellent","Forastero");
        this.agregarProductos(3,"Excellent","Kitten","1","5630","Gato","Excellent","Forastero");
        this.agregarProductos(4,"Excellent","Kitten","7.5","33163","Gato","Excellent","Forastero");
        this.agregarProductos(5,"Excellent","Sterilized","1","5910","Gato","Excellent","Forastero");
        this.agregarProductos(6,"Excellent","Sterilized","7.5","34508","Gato","Excellent","Forastero");
        this.agregarProductos(7,"Excellent","Urinary","1","5910","Gato","Excellent","Forastero");
        this.agregarProductos(8,"Excellent","Urinary","7.5","34508","Gato","Excellent","Forastero");
        this.agregarProductos(9,"Excellent","Puppy Small","3","9671","Perro","Excellent","Forastero");
        this.agregarProductos(10,"Excellent","Puppy Small","15","37918","Perro","Excellent","Forastero");
        this.agregarProductos(11,"Excellent","Puppy Grande","3","9367","Perro","Excellent","Forastero");
        this.agregarProductos(12,"Excellent","Puppy Grande","15","36728","Perro","Excellent","Forastero");
        this.agregarProductos(13,"Excellent","Mini Adulto","3","8846","Perro","Excellent","Forastero");
        this.agregarProductos(14,"Excellent","Mini Adulto","15","34701","Perro","Excellent","Forastero");
        this.agregarProductos(15,"Excellent","Adulto Grande","3","8494","Perro","Excellent","Forastero");
        this.agregarProductos(16,"Excellent","Adulto Grande","15","33308","Perro","Excellent","Forastero");
        ...
        this.agregarProductos(41,"Cat Chow","Adulto ","8","21660","Gato","Cat Chow","Forastero");
        this.agregarProductos(42,"Cat Chow","Adulto ","15","37260","Gato","Cat Chow","Forastero");
        this.agregarProductos(43,"Cat Chow","Kitten ","8","23308","Gato","Cat Chow","Forastero");
        this.agregarProductos(44,"Cat Chow","Kitten ","15","40130","Gato","Cat Chow","Forastero");
        this.agregarProductos(45,"Pro Plan","Adulto Small","7.5","31897","Perro", "Pro Plan","Forastero");
        this.agregarProductos(149,"Pro Plan","Adulto Small","3","15250","Perro", "Pro Plan","Forastero");
        this.agregarProductos(46,"Gati","Adulto ","15","21005","Gato","Gati","Forastero");
        ...
        this.agregarProductos(56,"Wishka","Adulto ","10","18755","Gato","Wishka","Don Tomas");
        ...
        this.agregarProductos(62,"Dog Chow","Adulto Senior","8","14758","Perro","Dog Chow","Forastero");
        this.agregarProductos(63,"Dog Chow","Mini Adulto","21","35440","Perro","Dog Chow","Forastero");
        this.agregarProductos(64,"Dog Chow","Adulto Light","8","15387","Perro","Dog Chow","Forastero");
        this.agregarProductos(65,"Dog Chow","Adulto Light","21","36906","Perro","Dog Chow","Forastero");
        ...
        this.agregarProductos(197,"Felix","Pouch","1","683","Gato","Catchow","Forastero");
        this.agregarProductos(115,"Felix","Pouch","15","10245","Gato","Catchow","Forastero");
