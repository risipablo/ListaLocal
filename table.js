...
class Datos {
    constructor() {
        ...
        this.agregarProductos(17,"Agility","Adulto Grande",20,"23000","Perro","Excellent","Adulto");
        this.agregarProductos(18,"Biopet","Adulto",1,"800","Perro","Biopet","Adulto");
        this.agregarProductos(19,"Biopet","Adulto",20,"14000","Perro","Biopet","Adulto");
        this.agregarProductos(164,"Biopet","Mini Small",1,"1200","Perro","Biopet","Mini Adulto");
        this.agregarProductos(165,"Biopet","Mini Small",15,"15400","Perro","Biopet","Mini Adulto");
        ...
        this.agregarProductos(56,"Infinity","Mini Adulto",1,"1200","Perro","Infinity","Adulto");
        this.agregarProductos(57,"Infinity","Mini Adulto ",15,"13000","Perro","Infinity","Adulto");
        this.agregarProductos(58,"Nutricare","Mini Adulto",1,"1200","Perro","Nutricare","Adulto");
        this.agregarProductos(59,"Nutricare","Mini Adulto ",20,"18000","Perro","Nutricare","Adulto");
        this.agregarProductos(60,"Nutricare","Adulto Grande",1,"1200","Perro","Nutricare","Adulto");
        this.agregarProductos(61,"Nutricare","Adulto Grande ",20,"18000","Perro","Nutricare","Adulto");
        this.agregarProductos(62,"Nutricare","Cachorro ",1,"1200","Perro","Nutricare","Cachorro");
        this.agregarProductos(63,"Nutricare","Cachorro",15,"15500","Perro","Nutricare","Cachorro");
        this.agregarProductos(190,"Piedras Blancas","Adulto","2","800","Gato","Piedras","Adulto")
        this.agregarProductos(191,"Nutricare","Adulto Grande ",7.5,"6600","Perro","Nutricare","Adulto");
        this.agregarProductos(192,"Nutricare","Mini Adulto ",7.5,"6600","Perro","Nutricare","Adulto");
        this.agregarProductos(193,"Nutricare","Adulto ",1,"1700","Gato","Nutricare","Adulto");
        this.agregarProductos(194,"Nutricare","Adulto ",7.5,"11800","Gato","Nutricare","Adulto");
        ...
        this.agregarProductos(128,"Felix","Pouch",1,"550","Gato","Catchow","Adulto");
        ...
        this.agregarProductos(228,"Keiko","Adulto",1,"600","Perro","Keiko","Adulto");
        this.agregarProductos(229,"Keiko","Adulto",21,"11500","Perro","Keiko","Adulto");
        this.agregarProductos(230,"Keiko","Cachorro",1,"800","Perro","Keiko","Adulto");
        this.agregarProductos(231,"Keiko","Cachorro",15,"11800","Perro","Keiko","Adulto");
